...
#define _DUTY_MAX 1714 // 2000
#define _DUTY_NEU 1400 // 1500
#define _DUTY_MIN 1034 // 1000

#define _SERVO_ANGLE_DIFF  60.6  // Replace with |D - E| degree
...
float volt_to_distance(int x)
{
  ...
  return 619-2.56*x+3.94E-03*x*x-2.27E-06*x*x*x;
}
